...
<template>
<button  class="fixed top-0 left-0 "  @click="activeSidebar = !activeSidebar">Toggle Sidebar</button>
<div class="fixed right-0 top-0 w-1/2 overflow-hidden bg-white rounded-lg transition-all" :class="{'translate-x-0': activeSidebar, 'translate-x-full': !activeSidebar}">
            ...
            <div class="flex flex-col flex-grow pt-5 overflow-y-auto border-r bg-neutral-800">
                ...
                <div class="flex flex-col flex-grow px-4 mt-5">
                    <nav class="flex-1 space-y-1 bg-neutral-800">
                        <ul>
                            <li>
                                <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-neutral-200 bg-neutral-900 border-neutral-900 focus:shadow-outline" white="" width="70" href="#">
                        ...
                        <ul>
                            <li>
                                <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transition duration-500 ease-in-out transform border rounded-lg text-neutral-200 border-neutral-800 hover:border-neutral-800 focus:shadow-outline hover:bg-neutral-900" white="" width="70" href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
